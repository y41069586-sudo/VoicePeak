...
> **DRAFT — to be finalized with a lawyer before release.** Replace bracketed
> fields. Localized versions (EN/DE/ES/FR/IT) ship in the app's String Catalog
> and are reachable in Settings → Legal in the active language.
...
## Acceptable use
Don't misuse the app or infringe others' rights. Product information is provided
